...
dataset = ImageDataset(img_dir='images/train', label_file='classification_label',transform=transform,split_ratio=0.8, train=True)
test_dataset = ImageDataset(img_dir='images', label_file='classification_label.txt', transform=transform, split_ratio=0.8, train=False)
dataloader = torch.utils.data.DataLoader(dataset, batch_size=32, shuffle=True)
testloader = torch.utils.data.DataLoader(test_dataset, batch_size=batch_size, shuffle=True, num_workers=num_workers)
