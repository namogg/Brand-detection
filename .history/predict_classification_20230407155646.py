...
"""
 ...
 model = model.load_state_dict(torch.load('classification_model.pt'))
...
img = Image.open("C:/Users/ADMIN/Documents/TensorFlow/workspace/training_demo/images/apple_fintech.jpg")
