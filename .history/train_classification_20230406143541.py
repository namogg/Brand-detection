...
vgg = models.resnet101(pretrained=True)
...
optimizer = torch.optim.SGD(resnet.parameters(), lr=0.00005, momentum=0.9)
num_epochs = 250
...
test_dataset = ImageDataset(img_dir='images/train', label_file='classification_label', transform=transform, split_ratio=0.8, train=False)
