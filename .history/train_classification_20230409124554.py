...
trainloader = torch.utils.data.DataLoader(train_data, batch_size=24, shuffle=True, drop_last = True )
testloader = torch.utils.data.DataLoader(test_data, batch_size=24, shuffle=True,drop_last = True)
