...
results = model.predict(source = "E:/Brand detect/Brand-detection/test/images/mcdonald.jpg" , conf = 0.2, show=False) 
...
for result in results: 
    ...
    img = Image.fromarray(cropped_img) = create_transform()
