...
annotations = [('image1.jpg', 'car', 'Toyota', 10, 20, 50, 80),
               ('image1.jpg', 'car', 'Honda', 60, 30, 90, 70),
               ('image2.jpg', 'person', 'Unknown', 20, 30, 40, 60)]

# Convert list of tuples to DataFrame
df = pd.DataFrame(annotations, columns=['filename', 'label', 'brand', 'xmin', 'ymin', 'xmax', 'ymax'])
