...
results = model.predict(source = "E:/Brand detect/Brand-detection/test/videos/mcdonald2.mp4" , conf = 0.15, show=False) 
#cv2.waitKey()
...
for result in results: 
    ...
    if bbox.numel():
        ...
        brand = show_prediction(img_tensor,model_classification,show=True,class_names,threshold=0.9)
