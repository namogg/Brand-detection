...
dataset = ImageDataset(img_dir='images/train', label_file='classification_label.txt',transform=transform,split_ratio=0.8, train=True)
test_dataset = ImageDataset(img_dir='images/train', label_file='classification_label.txt', transform=transform, split_ratio=0.8, train=False)
...
for epoch in range(num_epochs):
    ...
    for i, data in enumerate(dataloader, 0):
        ...
        print('labels shape:', labels.shape)qww
        optimizer.zero_grad()
