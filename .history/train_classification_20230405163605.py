...
train_dataset = CustomImageDataset(annonation = "classification label.txt",img_dir = data_dir, transform=transforms)
# Set the class names for the dataset
train_dataset.classes = class_names = list(label_map.keys())
